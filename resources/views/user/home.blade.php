  ...
  <footer class="page-footer">
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Contact</h5>
          <p class="footer-link mt-2">41,Wolfenbutteler Street,Magdeburg,39112.</p>
          <a href="#" class="footer-link">+49 163 5249019</a>
          <a href="#" class="footer-link">Divyeshjjodhani@gmail.com</a>
